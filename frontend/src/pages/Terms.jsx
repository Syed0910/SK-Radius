  ...
  return (
    <div className="bg-[#161719] min-h-screen py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-5xl font-bold text-[#e3dbd8] mb-8">Terms & Conditions</h1>
          <p className="text-gray-300 mb-8">
            Last updated: {new Date().toLocaleDateString()}
          </p>

          <div className="bg-[#fa6e43]/20 border border-[#fa6e43]/50 rounded-lg p-6 mb-8">
          ...
          <div className="mt-12 bg-[#161719]/50 border border-[#161719] rounded-lg p-8">
            <h3 className="text-xl font-semibold text-[#c0c0c0] mb-4">Questions?</h3>
